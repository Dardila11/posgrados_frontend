...
const DirectorListEvaluationsView = ({search, status, page}) => {
  ...
  return (
    <Page className={classes.root} title="Listado de evaluaciones">
      ...
      {loading ? (
        ...
        <>
        <List list={evaluationList} option="Evaluation" context="director" />
...
export default connect(mapStateToProps) (DirectorListEvaluationsView)
