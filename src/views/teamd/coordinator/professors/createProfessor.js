...
const CreateProfessorView = () => {
  ...
  const handleCreate = () => {
    ...
    CreateProfessorApi({
      ...
      .then(() => {
        document.getElementById('contenedorProfesor').innerHTML =
          "<div class='alert alert-success' role='alert'>Profesor creado correctamente!</div>";
      })
      .catch(() => {
        document.getElementById('contenedorProfesor').innerHTML =
