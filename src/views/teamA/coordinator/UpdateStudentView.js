...
const UpdateStudentView = () => {
  ...
  const handleSubmitUpdate = e => {
    UpdateStudent({
      ...
      .then(result => {
        alert('Se actualizo correctamente el estudiante');
      })
      .catch(() => alert('No se actualizo correctamente el estudiante'));
  };
  return (
    <Page className={classes.root} title="Actualizar estudiante">
                ...
                <CardContent>
                  <form onSubmit={handleSubmitUpdate}>
                    ...
                    <TextField
                      ...
                      margin="normal"
                      onChange={e => {
                        handleChangeScholarshipAgreement(e);
                        handleChange(e);
                      }}
                      select
                      SelectProps={{ native: true }}
                    ...
                    <TextField
                      error={Boolean(
                        touched.investigationGroup && errors.investigationGroup
                      )}
                      fullWidth
                      helperText={
                        touched.investigationGroup && errors.investigationGroup
                      ...
                      onBlur={handleBlur}
                      onChange={e => {
                        handleChangeInvestigationGroup(e);
                        handleChange(e);
                      }}
