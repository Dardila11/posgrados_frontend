        ...
        <Container maxWidth="sm">
          <Formik
            ...
            validationSchema={Yup.object().shape({
              name: Yup.string()
                .required('Nombre de la beca requerida')

                .max(255, 'Demasiado largo')
                .min(6, 'Demasiado corto'),
              description: Yup.string()
                .required('Descripción de la beca requerida')
                .max(255, 'Demasiado largo')
                .min(6, 'Demasiado corto'),
              ...
              long: Yup.number().required('Tiempo de duración requerido'),
              announcement: Yup.string()
                .required('Numero de convocatoria requerdo')
                .max(255, 'Demasiado largo')
                .min(6, 'Demasiado corto'),
              resolution: Yup.string()
                .required('Numero de resolución requerido')
                .max(255, 'Demasiado largo')
                .min(6, 'Demasiado corto')
            })}
            onSubmit={() => {
